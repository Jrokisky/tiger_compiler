...
fun yyAction47 (strm, lastMatch : yymatch) = (yystrm := strm;
      (if !commentDepth=0 then (YYBEGIN INITIAL; continue()) else (commentDepth := !commentDepth-1; continue())))
       ...
       of NONE => yyAction44(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction44(strm, yyNO_MATCH)
                  else yyQ54(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ49(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
              else yyAction44(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction44(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction44(strm, yyNO_MATCH)
                  else yyQ87(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ49(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
              else yyAction44(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction33(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              ...
              then if inp = #"="
                  then yyQ94(strm', yyMATCH(strm, yyAction33, yyNO_MATCH))
...
fun yyQ26 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction20(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ96(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
